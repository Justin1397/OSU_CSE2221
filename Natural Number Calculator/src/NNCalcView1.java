...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        //the first line
        buttonPanelMain.add(this.bDigits[7]);
        buttonPanelMain.add(this.bDigits[8]);
        buttonPanelMain.add(this.bDigits[9]);
        buttonPanelMain.add(this.bAdd);
        //the second line
        buttonPanelMain.add(this.bDigits[4]);
        buttonPanelMain.add(this.bDigits[5]);
        buttonPanelMain.add(this.bDigits[6]);
        buttonPanelMain.add(this.bSubtract);
        //the third line
        buttonPanelMain.add(this.bDigits[1]);
        buttonPanelMain.add(this.bDigits[2]);
        buttonPanelMain.add(this.bDigits[3]);
        buttonPanelMain.add(this.bMultiply);
        //the fourth line
        buttonPanelMain.add(this.bDigits[0]);
        buttonPanelMain.add(this.bPower);
        buttonPanelMain.add(this.bRoot);
        buttonPanelMain.add(this.bDivide);
        /*
         ...
         * to bottom
         */
        JPanel buttonPanelCombined = new JPanel();
        buttonPanelCombined.add(buttonPanelMain);
        buttonPanelCombined.add(buttonPanelSide);
        /*
