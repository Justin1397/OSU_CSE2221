...
public final class RSSAggregator {
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        //to create a XML tree of the feed
        XMLTree rss = new XMLTree1(url);
        //check if rss is available
        //create a simple writer for file
        ...
        if (rss.label().equals("rss") && (rss.hasAttribute("version"))
            ...
            //find the channel child in this feed
            ...
            //if there is error, print it
            out.println("There is an error for this rss feed whcih is " + file
                    + "!");
        }
    ...
    public static void main(String[] args) {
        ...
        out.print(
                "Enter the name of an XML file with a list of URLs for RSS feeds: ");
        ...
        //get the number of the feed
        int feedNum = feed.numberOfChildren();
        int i = 0;
        //output the format of the home page
        outFile.println("<html>");
        outFile.println("<head>");
        outFile.println("<title>" + feed.attributeValue("title") + "</title>");
        outFile.println("</head>");
        outFile.println("<body>");
        outFile.println("<h2>" + feed.attributeValue("title") + "</h2>");
        outFile.println("<ul>");
        //output the list in the home page
        while (i < feedNum) {
            outFile.println("<li><a href="
                    + feed.child(i).attributeValue("file") + ">"
                    + feed.child(i).attributeValue("name") + "</a></li>");
            i++;
        }
        outFile.println("</ul>");
        outFile.println("</body>");
        outFile.println("</html>");
        //output the feed files
        i = 0;
        while (i < feedNum) {
            //name the file in the feed
            String subFileName = feed.child(i).attributeValue("file");
            //process the feed
            processFeed(feed.child(i).attributeValue("url"), subFileName, out);
            i++;
        }
